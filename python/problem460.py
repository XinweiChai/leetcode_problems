...
class DLinkedList:
    ...
    def __init__(self):
        ...
        self._sentinel.next = self._sentinel.prev = self._sentinel  # make a circle s.t. _sentinel.prev = tail
        self._size = 0
...
if __name__ == '__main__':
    ...
    # for k, (i, j) in enumerate(zip(operators, operands)):
    #     print(k, eval('obj.' + i)(*j))
